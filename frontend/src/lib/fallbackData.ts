...
export const fallbackServices = [
  ...
  {id:'2', number:'02', title:'Прощальный зал', description:'Предоставление спокойного и достойного пространства для прощальной церемонии.', slug:'proshchalnyy-zal'},
  ...
  {id:'9', number:'09', title:'Эвакуация умерших', description:'Организация перевозки умершего в соответствии с необходимыми процедурами.', slug:'evakuatsiya-umershih'},
  ...
  {id:'14', number:'14', title:'Организация кремации', description:'Организация кремации и сопутствующих услуг.', slug:'organizatsiya-kremacii'},
];
